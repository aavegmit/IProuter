...
router: main.o sniffer.o parse_packet.o arp.o routingTable.o writePacket.o
	g++ -o router main.o sniffer.o parse_packet.o arp.o routingTable.o writePacket.o -D_REETRANT -lpthread -lpcap
