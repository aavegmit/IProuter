...
//    strcpy(sf1.expression, "ip and !(broadcast || multicast || src host 10.99.0.3 || src host 10.10.0.2 || dst host 10.99.0.1 || dst host 10.99.0.2 || dst host 10.10.0.1 || (src host 10.99.0.2 and dst host 10.99.0.3) || (src host 10.99.0.1 and dst host 10.99.0.3) || (src host 10.10.0.1 and dst host 10.10.0.2))");
    strcpy(sf1.expression, "ip and src host 192.168.0.12 and dst host 192.168.0.13");
